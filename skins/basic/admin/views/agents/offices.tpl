<div id="agents_add_client_div">
    <form id="office_add_form" action="{'agents.offices'|fn_url}">
        <input type="hidden" name="office[company_id]" value="{$office.company_id}">
        <input type="hidden" name="dispatch" value="agents.offices">
