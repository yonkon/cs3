...
//    $params = LastView::instance()->update('products', $params);
    ...
    if(isset($params['sort_name']) && strtolower($params['sort_name']) != 'desc'){
       $order[] = db_quote(' product_descriptions.product asc');
    }   else    {
        $order[] = db_quote(' product_descriptions.product desc');
    }

    if(isset($params['sort_prise']) && strtolower($params['sort_prise']) != 'desc'){
        $order[] = db_quote(' product_prices.product asc');
    }   else    {
        $order[] = db_quote(' product_prices.product desc');
    }
